...
from starting_kit.read_mask import CROP, WEED
...
if __name__ == "__main__":
    ...
    with open('starting_kit/predictions/submission.json', 'r') as f:
    ...
    original_mask = np.load('starting_kit/predictions/arr_mask_example.npy')
    ...
    reconstructed_rgb_arr[reconstructed_mask == 1] = CROP
    reconstructed_rgb_arr[reconstructed_mask == 2] = WEED

    reconstructed_rgb_img = Image.fromarray(
        np.uint8(reconstructed_rgb_arr))
    reconstructed_rgb_img.save('starting_kit/predictions/rle_decoded_rgb_mask.png')
